...
/**
 * Represents size of block for grouping buttons during layout 1-6
 *  
 * @var integer
 */
    protected $buttonsGroupColumns = 6;
    
   /**
    * Represents size of block for grouping buttons during layout 1-7
    *  
    * @var integer 
    */
        protected $buttonsGroupRows = 7;
